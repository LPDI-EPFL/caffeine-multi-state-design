...
mut_syn_02 = [('B', 41), ('B', 47), ('H', 64)]
flex_syn_02 = [('B', 64), ('B', 67), ('H', 41), ('H', 47), ('H', 67)]
mut_syn_03 = [('B', 41), ('B', 47), ('H', 41), ('H', 47)]
flex_syn_03 = [('B', 64), ('B', 67), ('H', 64), ('H', 67)]
mut_syn_04 = [('B', 64), ('H', 64)]
flex_syn_04 = [('B', 41), ('B', 47), ('B', 67), ('H', 41), ('H', 47), ('H', 67)]
flex_wt_05 = [('B', 41), ('B', 47), ('B', 64), ('B', 67)]
flex_syn_06 = [('B', 64), ('B', 67)]
mut_syn_06 = [('B', 41), ('B', 47)]
...
for statekey in states: 
  ...
  resfile = open (statekey+'/'+'resfileBp', 'w')
