...
base_ematrix_directory = base_data_directory+"02bp-energyMatrices_groupBp/"
...
stateDefs.append({'type':'negative','name':'03-synCafB:CFF:synCafB', 'id': 'negBB', 'color':'magenta', 'homo': ['B', 'H']})
stateDefs.append({'type':'negative','name':'04-synCafH:CFF:synCafH', 'id': 'negHH',  'color':'magenta', 'homo': ['H', 'B']})
