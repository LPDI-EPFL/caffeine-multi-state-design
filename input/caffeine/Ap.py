...
base_ematrix_directory = base_data_directory+"02ap-energyMatrices_groupAp/"
...
stateDefs.append({'type':'negative','name':'03-synCafB:CFF:synCafB', 'id': 'negB', 'color':'magenta', 'homo': ['B', 'H']})
stateDefs.append({'type':'negative','name':'04-synCafH:CFF:synCafH', 'id': 'negH',  'color':'magenta', 'homo': ['H', 'B']})
